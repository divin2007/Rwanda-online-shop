  ...
  return (
    ...
    >
      ...
      <div className="flex-grow space-y-1">
        <p className="text-[8px] font-bold text-[#1b4332] uppercase tracking-widest">{product.category || t('heritage_artifacts')}</p>
        <h4 className="text-sm font-sans text-[#1b1c1c] group-hover:text-[#1b4332] transition-colors line-clamp-1">{product.name}</h4>
