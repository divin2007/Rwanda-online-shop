...
async function seed() {
    ...
    try {
        ...
        const productSchema = new mongoose_1.default.Schema({
            ...
            price: Number,
            category: String,
            marketId: mongoose_1.default.Schema.Types.ObjectId,
            sellerId: mongoose_1.default.Schema.Types.ObjectId,
            images: [String],
            stockType: String,
        ...
        const Market = mongoose_1.default.models.Market || mongoose_1.default.model('Market', marketSchema);
        ...
        for (const m of marketsData) {
            ...
            const market = await Market.findOneAndUpdate({ code: m.code }, {
                name: m.name,
                slug: m.slug,
                code: m.code,
                type: m.type,
            ...
            for (let i = 1; i <= 5; i++) {
                ...
                await Product.findOneAndUpdate({ slug: `${market.slug}-item-${i}` }, {
                    name: prodName,
